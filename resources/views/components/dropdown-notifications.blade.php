    ...
    <div
        ...
        <ul>
            <li class="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
                <a id="suhu-notification" class="block py-2 px-4 hover:bg-gray-50 dark:hover:bg-gray-700/20" href="#0" @click="open = false" @focus="open = true" @focusout="open = false">
                    <!-- Suhu notification will be updated here -->
                </a>
            </li>
            <li class="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
                <a id="kelembapan-notification" class="block py-2 px-4 hover:bg-gray-50 dark:hover:bg-gray-700/20" href="#0" @click="open = false" @focus="open = true" @focusout="open = false">
                    <!-- Kelembapan notification will be updated here -->
                </a>
            </li>
        </ul>
    </div>
