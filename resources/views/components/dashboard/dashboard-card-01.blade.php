<div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
    <div class="px-5 pt-5">
        <header class="flex justify-between items-start mb-2">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Pameungpeuk</h2>
            <!-- Menu button -->
        ...
        <div class="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase mb-1">Data Suhu</div>
