<div class="flex flex-col col-span-full sm:col-span-6 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
    ...
    <div class="px-5 py-3">
        <div class="flex items-start">
            <div class="text-3xl font-bold text-gray-800 dark:text-gray-100 mr-2 tabular-nums"><span id="dashboard-card-04-value">57.81</span></div>
            <div id="dashboard-card-04-deviation" class="text-sm font-medium px-1.5 rounded-full"></div>
        </div>
    </div>
    <div class="grow">
