<div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
    <div class="px-5 pt-5">
        <header class="flex justify-between items-start mb-2">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Muhammad Arfa Dhiya Ulhaq</h2>
            <!-- Menu button -->
        ...
        <div class="p-3 flex flex-col items-center">
            <img class="object-cover object-center rounded-full" width="200" height="100" src="{{ asset('images/profil-arfa.jpg') }}" alt="Profile image" />
            <!-- Address Section -->
            <div class="mt-6 text-sm text-gray-600 dark:text-gray-300">
                ...
                <div class="flex items-center mb-1">
                    ...
                    <span>Skill : IOT / Controller / Data Visual</span>
                </div>
                <!-- Address -->
                <div class="flex items-center mb-1">
                ...
                <div class="flex items-center">
                    ...
                    <span>LinkedIn : Muhammad Arfa Dhiya Ulhaq</span>
                </div>
            </div>
        </div>
    </div>
