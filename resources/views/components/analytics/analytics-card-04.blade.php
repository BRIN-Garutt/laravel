<div class="flex flex-col col-span-full sm:col-span-6 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
    <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60 flex items-center">
        <h2 class="font-semibold text-gray-800 dark:text-gray-100">Suhu Kota Garut</h2>
    ...
    <div class="px-5 py-3">
        <div class="flex items-start">
            <div class="text-3xl font-bold text-gray-800 dark:text-gray-100 mr-2 tabular-nums"><span id="analytics-card-04-value">00.00</span></div>
            <div id="analytics-card-04-deviation" class="text-sm font-medium px-1.5 rounded-full"></div>
        </div>
    </div>
    <div class="grow">
