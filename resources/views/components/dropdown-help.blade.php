...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    <div
        ...
        x-cloak>
        <div class="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase pt-1.5 pb-2 px-3">Made in</div>
        <ul>
            <li>
                <a class="font-medium text-sm text-violet-500 hover:text-violet-600 dark:hover:text-violet-400 flex items-center py-1 px-3" href="https://responsible-fact-6d4.notion.site/Laravel-7f15bb8f7b9b49bf88993984d27e4629?pvs=4" @click="open = false" @focus="open = true" @focusout="open = false">
